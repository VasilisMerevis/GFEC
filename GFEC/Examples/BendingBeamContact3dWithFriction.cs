...
namespace GFEC
{
    public static class BendingBeamContact3dWithFriction
    {
        ...
        public static Results RunStaticExample()
        {
            ...
            //double[,] globalStiffnessMatrix1 = new double[552, 552];
            //double[,] globalStiffnessMatrix2 = new double[513, 513];
            //for(int i = 0; i< 552; i++)
            //{
            //    for(int j =0; j< 552; j++)
            //    {
            //        globalStiffnessMatrix1[i, j] = globalStiffnessMatrix[i, j];
            //    }
            //}
            //for (int i = 0; i < 513; i++)
            //{
            //    for (int j = 0; j < 513; j++)
            //    {
            //        globalStiffnessMatrix2[i, j] = globalStiffnessMatrix[552 + i, 552 + j];
            //    }
            //}
            //string globalStiffnessMatrixname = "Ktot" + 0.ToString() + ".dat";
            //string globalStiffnessMatrix1name = "K1" + 0.ToString() + ".dat";
            //string globalStiffnessMatrix2name = "K2" + 0.ToString() + ".dat";
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix, @"C:\Users\Public\Documents\" + globalStiffnessMatrixname);
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix1, @"C:\Users\Public\Documents\" + globalStiffnessMatrix1name);
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix2, @"C:\Users\Public\Documents\" + globalStiffnessMatrix2name);
            ...
            //VectorOperations.PrintVectorToFile(reducedExternalForces3, @"C:\Users\Public\Documents\" + "Fext" + ".dat");
            ...
            //    }
            //}
            //globalStiffnessMatrixname = "Ktot" + 2.ToString() + ".dat";
            //globalStiffnessMatrix1name = "K1" + 2.ToString() + ".dat";
            //globalStiffnessMatrix2name = "K2" + 2.ToString() + ".dat";
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix, @"C:\Users\Public\Documents\" + globalStiffnessMatrixname);
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix1, @"C:\Users\Public\Documents\" + globalStiffnessMatrix1name);
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix2, @"C:\Users\Public\Documents\" + globalStiffnessMatrix2name);
            ...
            //    }
            //}
            //globalStiffnessMatrixname = "Ktot" + 15.ToString() + ".dat";
            //globalStiffnessMatrix1name = "K1" + 15.ToString() + ".dat";
            //globalStiffnessMatrix2name = "K2" + 15.ToString() + ".dat";
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix, @"C:\Users\Public\Documents\" + globalStiffnessMatrixname);
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix1, @"C:\Users\Public\Documents\" + globalStiffnessMatrix1name);
            //MatrixOperations.PrintMatrixToFile2(globalStiffnessMatrix2, @"C:\Users\Public\Documents\" + globalStiffnessMatrix2name);
