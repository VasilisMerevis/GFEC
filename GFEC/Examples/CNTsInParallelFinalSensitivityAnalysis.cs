...
namespace GFEC
{
    public static class CNTsInParallelFinalSensitivityAnalysis
    {
        private const int offsetNodes = 2; /*73;*///65;/*55;*//*41;*//*29;*///17;//2
        private const int totalNodes = 648;//2254,648;
        private const int addedNodesrodElements = 2;
        private const int totalElements = 480;//1920; 480;
        private const int nodesInXCoor = 81;//161
        private const int nodesInYCoor = 4;//7
        ...
        private static Dictionary<int, INode> CreateNodes()
        {
            ...
            nodes[totalNodes + 2] = new Node(xIntervals * scaleFactor * (nodesInXCoor - 1), yIntervals * (nodesInYCoor-1) + 0.41);
