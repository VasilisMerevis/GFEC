...
namespace GFEC
{
    class ANSSolidShell8EAS4NL : IElement
    {
        ...
        public ANSSolidShell8EAS4NL(IElementProperties properties, Dictionary<int, INode> nodes)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                for (int j = 0; j < 2; j++)
                {
                    for (int k = 0; k < 2; k++)
                    {
                        ...
                        Dictionary<int, Dictionary<string, double[]>> aStrainPoints = AssumedStrainSamplingPoints(nodalXInitial, gP[2]);
                        Dictionary<int, Dictionary<string, double[]>> aStrainPointsDU = AssumedStrainSamplingPointsDU(gP[2]);
        ...
        public void UpdateElementEASParameters(double[] deltaU)
        {
            ...
            double[] aNext = VectorOperations.VectorVectorSubtraction(aPrevious,
                            ...
                            VectorOperations.MatrixVectorProduct(matrixLe, deltaU), vectorPe)));
        ...
        private Dictionary<int, Dictionary<string, double[]>> AssumedStrainSamplingPoints(double[] nodalXInitial, double zita)
        {
            Dictionary<int, Dictionary<string, double[]>> assumedStrainPoints = new Dictionary<int, 
                Dictionary<string, double[]>>();

            double[] A = new double[] { 0.0, -1.0, zita };
            double[] B = new double[] { 1.0, 0.0, zita };
            double[] C = new double[] { 0.0, 1.0, zita };
            double[] D = new double[] { -1.0, 0.0, zita };
        ...
        private Dictionary<int, Dictionary<string, double[]>> AssumedStrainSamplingPointsDU(double zita)
        {
            Dictionary<int, Dictionary<string, double[]>> assumedStrainPoints = new Dictionary<int,
                Dictionary<string, double[]>>();
