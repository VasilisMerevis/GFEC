...
namespace GFEC
{
    class ANSSolidShell8LEAS1FI : IElement
    {
        ...
        public ANSSolidShell8LEAS1FI(IElementProperties properties, Dictionary<int, INode> nodes)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                for (int j = 0; j < 2; j++)
                {
                    for (int k = 0; k < 2; k++)
                    {
                        ...
                        //double[] stressVectorModified = CalculateStressVector(E, CalculateStrainsVector(B));
